...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1 border-b border-border/70 pb-4 text-right", className)}
      {...props}
    />
  )
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-4 flex flex-col gap-2 p-0", className)}
      {...props}
    />
  )
}
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-lg font-semibold text-foreground text-right",
        className
      )}
      {...props}
    />
